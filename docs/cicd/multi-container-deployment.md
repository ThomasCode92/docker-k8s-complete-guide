...
![aws managed service](./images/managed-services.excalidraw.png)

## AWS VPC's and Security Groups

AWS _Virtual Private Clouds (VPCs)_ and _Security Groups_ provide secure, isolated networking with fine-grained control over traffic flow, ensuring resources remain protected. Network configuration is simplified with fine-grained control over traffic, allowing segmentation and monitoring of inbound and outbound connections.

![aws vpc's](./images/vpc-security.excalidraw.png)
